...
\title{Peter Christensen} % Print the main header
...
{\bf Address} \> 431 Mumford Hall,\\ % Address line 1
\>  1301 W. Gregory Dr. \\ % Address line 2
\>  University of Illinois, Urbana-Champaign \\ % Address line 2
...
\begin{tabbing} % Enables tabbing
\hspace{3cm} \= \hspace{4cm} \= \kill % Spacing within the block
{\bf Office:} \> 217-300-3054 \\ % Home phone
{\bf Mobile:} \> 203-506-6724 \\ % Mobile phone
{\bf Email} \> \href{mailto:pchrist@illinois.edu}{pchrist@illinois.edu} \\ % Email address
\end{tabbing}}
...
\tabbedblock{
\bf{2015-} \> \textbf{Assistant Professor}, Department of Agricultural and Consumer Economics \\
\>\+ \hspace{31mm} University of Illinois, Urbana-Champaign\\
\textbf{Core Faculty}, \hspace{9mm} National Center for Supercomputing Applications \\
\ \hspace{30mm} University of Illinois, Urbana-Champaign\\
}
...
\tabbedblock{
\bf{2015} \>Ph.D. Environmental and Resource Economics, Yale University. New Haven, CT\\
\bf{2009} \>M.E.Sc. Environmental Economics and Policy (conc), Yale F\&ES, New Haven, CT.\\
\bf{2004} \>B.A. Psychology, Summa Cum Laude, UC Davis.\\
}
